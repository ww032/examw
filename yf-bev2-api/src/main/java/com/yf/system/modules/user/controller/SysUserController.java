...
public class SysUserController extends BaseController {
     ...
     * 人脸验证登录（新增接口）
     */
    @Operation(summary = "人脸验证登录", description = "账号密码+身份证+百度AI人脸识别登录")
    @PostMapping(value = "/face-login") // 新增接口路径，与原有/login区分，语义清晰
    public ApiRest<SysUserLoginDTO> faceLogin(@Valid @RequestBody SysUserFaceLoginReqDTO reqDTO) {
        // 调用Service层新增的人脸登录方法，返回与原有登录接口一致的SysUserLoginDTO
